...
//M/D/Y --> Y-M-D
        ...
        $query .= "INSERT INTO tblTasks(fnkEmail, fldTask, fldDescription, fld ToDoDate) VALUES ('khearn@uvm.edu', '" . $task . "', '" . $details . "', '" . $toDoDate . "')";
        $query .= "INSERT INTO tblRelationship(fnkEmail, fnkCategoryId, fnkTaskId) VALUES ('" . $email . "', '" . $catId . "', '" . $taskId . "')";
        $query .= "INSERT INTO tblCategories(pmkCategoryId, fldCategory)VALUES ('" . $catId . "', '" . $category . "')";
        $query .= "COMMIT";
